...
structured_router.py selects exact facts from governed CSV outputs.

FAISS retrieves explanatory evidence from evidence_docs/*.md using Gemini embeddings.

Gemini writes a natural-language answer from the selected facts and retrieved evidence.
...
Successful answer/refusal rate
